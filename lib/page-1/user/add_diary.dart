...
class _AddDiary extends State<AddDiary> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text("إضافة ذكرة ليومياتي",style: SafeGoogleFont (
                                  'Roboto',
                                  fontSize: 20,
                          ...
                          Container(
                            ...
                            child: Text("أكتبي ما تريدين ان تتذكريه لاحقا..",style: SafeGoogleFont (
                                'Roboto',
                                fontSize: 19,
