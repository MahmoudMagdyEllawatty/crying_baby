...
class TabUserNotifications extends StatefulWidget {
  @override
  _TabUserNotifications createState() => _TabUserNotifications();
}

class _TabUserNotifications extends State<TabUserNotifications> {
