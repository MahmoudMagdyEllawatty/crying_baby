...
class EditNotification extends StatefulWidget {
  @override
  _EditNotification createState() => _EditNotification();
}
...
class _EditNotification extends State<EditNotification> {
  ...
  Messages messages = Messages(description: '', title: "");
  ...
  void initState() {
    ...
    messages = SharedData.message;
    setState(() {
      _nameController.text = messages.title;
      _descriptionController.text = messages.description;
    });
    super.initState();
